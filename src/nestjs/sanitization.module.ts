...
} from './normalization.interceptor';
import {
...
export interface SanitizationModuleAsyncOptions {
  useFactory?: (
    ...args: unknown[]
  ) => Promise<SanitizationModuleConfig> | SanitizationModuleConfig;
...
export class SanitizationModule {
  ...
  static forFeature(config?: Partial<SanitizationModuleConfig>): DynamicModule {
    const providers: Provider[] = [SanitizationPipe, NormalizationInterceptor];
  ...
  private static createAsyncProviders(
    options: SanitizationModuleAsyncOptions
  ): Provider[] {
